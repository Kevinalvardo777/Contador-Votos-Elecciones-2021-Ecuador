...
const PresidentList = () => (
    ...
    <Card.Group itemsPerRow={3}>
        <Card >
            <Image src='https://notimundo.com.ec/wp-content/www/uploads/2017/01/Elecciones-2017_GuillermoLasso.jpg' 
            style={{left: '70px', height:'170px', width: '130px'}}/>
        ...
        <Card>
            <Image src='https://edunewscolombia.files.wordpress.com/2010/05/fabricio-correa.jpg?w=584' style={{left: '60px', height: '160px'}} />
            <Card.Content>
            <Card.Header>Fabricio Correa</Card.Header>
            <Card.Meta>Justicia Social</Card.Meta>
            <input 
                type="text"
                id="nombre"
                name="nombre"
